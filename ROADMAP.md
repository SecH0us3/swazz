...
- [ ] **Task 120: Project-Level E2EE Key Backup & Recovery (Backup File + Seed Phrase)**
  - **Design Goal:** Support exporting and importing the Project X25519 private key in Project Settings via a downloaded backup file (`.swazzkey`) or a 12-word mnemonic seed phrase, enabling seamless device migration and collaboration without losing access to historical encrypted reports. Includes a link in the UI to the [Key Backup & Recovery guide](file:///Users/alex/src/swazz/docs/encryption_backup.md).
  - **Implementation Details:**
