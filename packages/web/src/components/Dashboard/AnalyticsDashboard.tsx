...
const PRETTY_CATEGORIES: Record<string, string> = {
    ...
    'swazz/hsts-missing': 'Missing HSTS Header',
    'swazz/hsts-insecure': 'Insecure HSTS Configuration',
    'swazz/x-frame-options-missing': 'Missing Clickjacking Protection',
    'swazz/x-frame-options-insecure': 'Insecure X-Frame-Options',
    'swazz/x-content-type-options-missing': 'Missing MIME Sniffing Protection',
    'swazz/x-content-type-options-insecure': 'Insecure X-Content-Type-Options',
    'swazz/server-header-leak': 'Server Header Version Leak',
    'swazz/x-powered-by-leak': 'X-Powered-By Header Leak',
    'swazz/x-aspnet-version-leak': 'X-AspNet-Version Header Leak',
