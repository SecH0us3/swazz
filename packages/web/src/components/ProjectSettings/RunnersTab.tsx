            ...
            {isLoadingRunners && runners.length === 0 ? (
                ...
                <div style={{
                    ...
                    <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left', fontSize: '13px' }}>
                        ...
                        <tbody>
                            {runners.map((r, i) => (
                                <tr key={`${r.name}-${r.publicKey || 'nokey'}`} style={{ borderBottom: i === runners.length - 1 ? 'none' : '1px solid var(--border-subtle)', backgroundColor: r.isMine ? 'rgba(124,58,237,0.03)' : 'transparent' }}>
