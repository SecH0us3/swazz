                        ...
                        <div className="code-switcher-content">
                            ...
                            {activeTab === 'docker' && (
                                <div className="code-block-wrapper">
                                    ...
                                    <pre className="code-terminal">
                                        <code>{`{\n  "version": "2.1.0",\n  "runs": [\n    {\n      "tool": {\n        "driver": {\n          "name": "swazz",\n          "rules": [\n            { "id": "swazz/status-500", "shortDescription": { "text": "Server error 500" } }\n          ]\n        }\n      },\n      "results": [\n        {\n          "ruleId": "swazz/status-500",\n          "level": "error",\n          "message": { "text": "500 on POST /api/login" },\n          "locations": [\n            {\n              "physicalLocation": { "artifactLocation": { "uri": "/api/login" } },\n              "logicalLocations": [ { "name": "POST", "kind": "function" } ]\n            }\n          ]\n        }\n      ]\n    }\n  ]\n}`}</code>
                                    </pre>
                                </div>
                            )}
                            {activeTab === 'worker' && (
